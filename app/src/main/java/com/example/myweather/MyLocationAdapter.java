...
public class MyLocationAdapter extends RecyclerView.Adapter<MyLocationAdapter.ViewHolder> {
    ...
    @Override
    public MyLocationAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = inflater.inflate(R.layout.location_row, parent, false);
        return new MyLocationAdapter.ViewHolder(view);
    }


    @Override
    public void onBindViewHolder(MyLocationAdapter.ViewHolder holder, int position) {
